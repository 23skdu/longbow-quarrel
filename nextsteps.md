...
3. [ ] **Activation Trace Analysis**: Run `ScanMax` tracking across all 32 layers for the first token to identify collapse/saturation.
...
- [ ] Implement enhanced `ScanMax` tracking in `engine.go`.
